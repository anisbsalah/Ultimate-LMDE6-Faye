...
wget "https://github.com/wez/wezterm/releases/download/${release}/wezterm-${release}.Debian${DISTRIB_RELEASE}.deb" -O "/tmp/wezterm-${release}.Debian${DISTRIB_RELEASE}.deb"
sudo apt install -y "/tmp/wezterm-${release}.Debian${DISTRIB_RELEASE}.deb"
#sudo dpkg -i "/tmp/wezterm-${release}.Debian${DISTRIB_RELEASE}.deb"
